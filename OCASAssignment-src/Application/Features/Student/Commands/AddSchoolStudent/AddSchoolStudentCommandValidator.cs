...
{
    /// <summary>
    /// Add student validator, validates add student request properties before further processing the request in the handler function
    /// </summary>
    public class AddSchoolStudentCommandValidator : AbstractValidator<AddSchoolStudentCommand>
    {
        public AddSchoolStudentCommandValidator()
        {
            ...
            RuleFor(c => c.Student.LastName)
                ...
                .MaximumLength(100).WithMessage("Last code must not have length greater than 10 characters")
