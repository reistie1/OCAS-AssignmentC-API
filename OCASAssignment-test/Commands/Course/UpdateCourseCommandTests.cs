...
namespace OCASAPI_Tests.Commands
{
    public class UpdateCourseCommandTests
    {
        ...
        public UpdateCourseCommandTests()
        {
            ...
            _mockCourseRepo.Setup(c => c.EditCourseAsync(_mappedCourse)).ReturnsAsync(_mappedCourse);
        ...
        [Fact]
        public async Task UpdateCourseCommand_ReturnsAddedCourseEntity()
        {
            var command = new EditCourseCommand(_mappedCourseDto);
            var handler = new EditCourseCommandHandler(_mockMapper.Object, _mockCourseRepo.Object);
        ...
        [Fact]
        public async Task UpdateCourseCommand_ValidatesProperties()
        {
